        ...
        <form onSubmit={handleSubmit} className="px-6 py-4 space-y-3">
          ...
          <div className="flex justify-end gap-1.5 pt-1 pb-2">
            <button
              ...
              onClick={onClose}
              disabled={pending}
              className="rounded-md border border-zinc-200 dark:border-zinc-700 px-3 py-1.5 text-xs font-medium text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors disabled:opacity-50"
            >
              취소
            </button>
            <button
              type="submit"
              disabled={pending}
              className="rounded-md bg-[#3182F6] hover:bg-[#1a6fe8] active:bg-[#1560d4] disabled:opacity-50 px-3 py-1.5 text-xs font-semibold text-white transition-colors"
            >
